...
class BaseBEVBackboneTS(nn.Module):
    def __init__(self, model_cfg, input_channels):
        ...
        backbone_2d_weights = {k.replace('backbone_2d.', ''): v for k, v in checkpoint.items() if 'backbone_2d' in k}
        self.load_state_dict(backbone_2d_weights, strict=False)
