...
int boxes_iou3d_gpu(at::Tensor boxes_a, at::Tensor boxes_b, at::Tensor ans_iou){
    // params boxes_a: (N, 5) [x1, y1, z1, x2, y2, z2, ry]
    // params boxes_b: (M, 5)
    // params ans_overlap: (N, M)
    ...
    boxesiou3dLauncher(num_a, boxes_a_data, num_b, boxes_b_data, ans_iou_data);
...
int nms_3d_gpu(at::Tensor boxes, at::Tensor keep, float nms_overlap_thresh){
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("boxes_iou3d_gpu", &boxes_iou3d_gpu, "boxes_iou3d_gpu");
  m.def("boxes_overlap_bev_cpu", &boxes_overlap_bev_cpu, "oriented boxes overlap");
  m.def("boxes_iou_bev_cpu", &boxes_iou_bev_cpu, "boxes_iou_bev_cpu");
  m.def("boxes_iou3d_cpu", &boxes_iou3d_cpu, "boxes_iou3d_cpu");
  m.def("nms_gpu", &nms_gpu, "oriented nms gpu");
  m.def("nms_3d_gpu", &nms_3d_gpu, "oriented nms 3d gpu");
